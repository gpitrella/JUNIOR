...
export const SEND_INVITATION_TO_PROJECT = 'SEND_INVITATION_TO_PROJECT';
export const OPEN_MODAL_SEND_INVITATION = 'OPEN_MODAL_SEND_INVITATION';
export const CLOSE_MODAL_SEND_INVITATION = 'CLOSE_MODAL_SEND_INVITATION';
export const ENABLE_INVITATION_TO_PROJECT = 'ENABLE_INVITATION_TO_PROJECT';
